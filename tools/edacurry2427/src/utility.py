...
class Reverter:
    ...
    def __init__(self, circuit: edacurry.Circuit):
        ...
        if self._circuit is None:
            raise ValueError("[Reverter] Initialization error: invalid circuit\n")
    ...
    def push(self, operation):
        ...
        if not operation["defect_type"] in DefectType:
            error = f"[Reverter::push] Unable to push operation : 'defect_type' param must be one of the following:\n"
